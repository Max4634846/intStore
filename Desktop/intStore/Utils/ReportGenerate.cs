...
namespace intStore.Utils
{
    public class ReportGenerate
    {
        ...
        /// <summary>
        /// Генерирует отчет по заказам клиента, включая информацию о количестве заказов, общей стоимости,
        /// а также детализацию каждого заказа в виде таблицы. Отчет сохраняется в формате .docx в специальную
        /// директорию для каждого клиента.
        /// </summary>
